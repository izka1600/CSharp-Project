CREATE FUNCTION [utils].[uf_LoadDataFromCsvIntoXml] (@path nvarchar(100), @separator nvarchar(1))
RETURNS nvarchar(max) WITH EXECUTE AS CALLER, RETURNS NULL ON NULL INPUT
AS
EXTERNAL NAME [DatabaseFunctions].[UserDefinedFunctions].[uf_LoadDataFromCsvIntoXml]
Go  
