...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:keepupdbserver.database.windows.net,1433;Initial Catalog=Arkusz_Wydatki;Persist Security Info=False;User ID=IzaKukawska;Password=milopaWER905!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
